...
(function ($, window, document) {
    ...
    */
    _oExt.oStdClasses = {
        ...
        "sPageButton": "paginateEnabled",
        "sPageButtonActive": "paginateEnabled current",
        "sPageButtonStaticDisabled": "paginateDisabled",
        "sPageFirst": "first",
    ...
    $.fn.dataTable = function (oInit) {
        ...
        */
        function classSettings() {
            ...
            *   by javascript
            */
            //alert(SERVER_ROOT + '/App_Themes/CelloSkin/pagination_right_arrow.gif');
            this.oLanguage = {
                "sProcessing": "Processing...",
                "sLengthMenu": "Show _MENU_ entries",
                "sZeroRecords": '<div class="info">No matching records found</div>',
                "sEmptyTable": '<div class="info">No data available in table</div>',
                ...
                "sUrl": "",
                "oPaginate": {
                    "sFirst": '<a title="First" href="javascript:void(0)"><i class="fa fa-fast-backward" style="padding:0 5px;"></i></a>',
                    "sPrevious": '<a title="Previous" href="javascript:void(0)"><i class="fa fa-step-backward" style="padding:0 5px;"></i></a>',
                    "sNext": '<a title="Next" href="javascript:void(0)"><i class="fa fa-step-forward" style="padding:0 5px;"></i></a>',
                    "sLast": '<a title="Last" href="javascript:void(0)"><i class="fa fa-fast-forward" style="padding:0 5px;"></i></a>'
                },
                "fnInfoCallback": null
            };
        ...
        */
        function _fnAddOptionsHtml(oSettings) {
            ...
            */
            ...
            oSettings.nTable.parentNode.appendChild(nHolding);
            ...
            */
            ...
            pGrid.className = 'grid-pagination-control';

            oSettings.nTableWrapper.appendChild(pGrid);

            /* Track where we want to insert the option */
            //var nInsertNode = oSettings.nTableWrapper;
            var nInsertNode = pGrid;
            ...
            for (var i = 0; i < aDom.length; i++) {
                ...
                if (cOption == '<') {
                    ...
                    td.className = "paginate_length";
                    td.appendChild(_fnFeatureHtmlLength(oSettings));
                    ...
                    if (document.getElementById("filterPlaceHolder") == undefined) {
                        nTmp = _fnFeatureHtmlFilter(oSettings);
                        iPushFeature = 1;
                    }
                    else {
                        document.getElementById("filterPlaceHolder").appendChild(_fnFeatureHtmlFilter(oSettings));
                        iPushFeature = 0;
                    }
                }
                    ...
                    var td = document.createElement('div');
                    td.className = "paginate_info";
                    td.appendChild(_fnFeatureHtmlInfo(oSettings));
                    ...
                    var p = _fnFeatureHtmlPaginate(oSettings);
                    p.className = "aPager";
                    var td = document.createElement('div');
                    td.className = "paginate_pager";
                    td.appendChild(p);
                ...
                if (oSettings.aiDisplay.length == oSettings.aiDisplayMaster.length ||
                    ...
                    */
                    for (i = 0; i < oSettings.aiDisplayMaster.length; i++) {
                        //alert(oSettings.asDataSearch[i]);
        ...
        */
        function _fnFeatureHtmlLength(oSettings) {
            ...
            var sStdMenu = '<select style="width:50px" size="1" ' + sName + '>';
            var i, iLen;
            ...
            nLength.innerHTML = '<span>' + oSettings.oLanguage.sLengthMenu.replace('_MENU_', sStdMenu) + '</span>';
